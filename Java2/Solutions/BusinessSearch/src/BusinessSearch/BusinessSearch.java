...
class businessList {
    ...
    public void search() {
        ...
        while (true) {
            System.out.println("Enter the business name or a blank line to quit");
...
public class BusinessSearch {
    ...
    public static void main(String[] args) throws IOException {
        // creates a list from the directory
        String filename = "directory.txt";
        businessList theList = new businessList(filename);
        //sorts the list
        theList.mergeSort();
